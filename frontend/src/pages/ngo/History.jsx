  ...
  return (
    <div className="flex-1 p-4 sm:p-6 space-y-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
        ...
        <p className="text-sm text-gray-500 mt-1">Your completed and past donation pickups</p>
      </div>
          ...
          <>
            <div className="overflow-x-auto">
              <table className="w-full text-sm min-w-[600px]">
                ...
                <tbody>
                  {history.map((h) => (
                    <tr key={h._id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/70 transition-colors">
                      <td className="py-3.5 pl-2 font-medium text-gray-900">{h.foodName}</td>
                      ...
                      <td className="py-3.5">
                        <span className={`inline-flex items-center text-xs font-medium px-2.5 py-1 rounded-full capitalize ${statusBadge[h.finalStatus] || "bg-gray-100 text-gray-500"}`}>
                          {h.finalStatus}
                        </span>
                      </td>
                    </tr>
